...
def argparser():
    ...
    parser.add_argument("-t", "--transfer", type=str, default='',
                        help="specify the path of weights for transfer learning")
    ...
    parser.add_argument("-i", "--evaluation-interval", type=int, default=1,
...
class Trainer:
    ...
    def __init__(self, train_dataset, val_dataset, model, args=argparser):
        ...
        self.train_loader = DataLoader(train_dataset, self.args.batch_size, shuffle=True, num_workers=self.args.ncpu,
                                       pin_memory=is_cuda)
        self.val_loader = DataLoader(val_dataset, self.args.batch_size, shuffle=False, num_workers=self.args.ncpu,
                                     pin_memory=is_cuda)
