...
if __name__ == '__main__':
    ...
    img = Image.open("/home/yzs/backup/img/1_5.jpg")
    img = img.resize((416, 416))
    img_data = cfg.TRANSFORM(img)
    ...
    for i in range(len(out_vec)):
        ...
        draw.text(xy=(out_vec[i][0], out_vec[i][1]), text=cfg.CATEGORY_NAME[int(out_vec[i][5])], fill=(255, 0, 255),
                  font=font)
    print(time)
    img.show()
